...
<div id="homepage" class="row">
  ...
  <div class="span7">
    <section id="new_added">
        <h1 class="module__hed"><a href="/informationobject/browse?sort=lastUpdated&view=card&onlyMedia=1&topLod=0" target="_blank">See What's New
        <!--[if gte IE 9]><!--><svg viewBox='0 0 100 100' class='icon-chevron-right-large'><use xlink:href='#icon-chevron-right'></use></svg><!--<![endif]--></a></a></h1>
    </section>
  </div>
